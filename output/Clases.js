...
function () {
  function Usuario(nombre, edad, correo) {
    ...
    this.nombre = nombre, this.edad = edad, this.correo = correo; //alert('Hola')
  }
...
var jhonatan = new Usuario("carlos mario ", 31, "my@MimeType.com");
document.write(jhonatan.mostrarInfo());
var walter = new Usuario("WAlter Andres ", 30, "walter@wal.com");
document.write(walter.mostrarInfo());
var carlos = new Estudiante("Carlos Mario ", 35, "mi@my.com", "guarda de seguridad");
